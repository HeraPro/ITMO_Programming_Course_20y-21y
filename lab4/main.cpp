...
int main () {
    ...
    std::cout << "any_of - " << myspace::any_of(positive_numbers<int>, vec.begin(), vec.end()) << '\n';
    ...
    std::cout << "is_partitioned - " << myspace::is_partitioned(vec.begin(), vec.end(), positive_numbers<int>) << '\n';
